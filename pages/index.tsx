...
export default function Home() {
  ...
  useEffect(() => {
    const init = async () => {
      const existingParams = localStorage.getItem(LS_KEY);
      setParams(JSON.parse(existingParams || JSON.stringify(defaultParams)));
      setIsLoaded(true);
    ...
    <>
      ...
      <div className="flex absolute top-[64px] bottom-0 left-0 right-0">
        <main className="p-8 w-full">
          <h1 className="mb-4">Twitter API Playground</h1>
